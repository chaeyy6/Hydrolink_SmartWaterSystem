...
if (isset($_SESSION['UserID'])) {
  ...
  if (isset($_SESSION['Role']) && $_SESSION['Role'] === 'Admin') {
    ...
    $stmtAudit = $conn->prepare("
        ...
        VALUES (?, 'Visit', 'Visited Water Bottles Page (water_bottles.php)', ?, ?, NOW())
    ");
...
<head>
  <meta charset="utf-8">
  <title>Hydrolink - Water Bottles</title>
...
<body>
  ...
  <!-- Water Bottles (Blockchain Flow) Start -->
  <div class="container-fluid py-5 bg-white">
    <div class="container py-5">
      <!-- Section Header -->
      <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 900px;">
        <h4 class="text-uppercase text-primary">Water Bottles</h4>
        <h1 class="display-5 mb-3">How Blockchain Tracks Every Bottle</h1>
        <p class="text-muted">
          Every time a bottle is dispensed, a secure blockchain transaction is recorded — ensuring
          <strong>transparency</strong>, <strong>accountability</strong>, and <strong>trust</strong> for both sponsors
          and clients.
        </p>
      </div>

      <!-- Bottle + Blockchain Steps -->
      <div class="row align-items-center g-5">
          ...
          <div class="timeline">
            ...
            <div class="timeline-item wow fadeInLeft" data-wow-delay="0.2s">
              ...
              <div class="timeline-content">
                <h5>Bottle Dispensed</h5>
                <p>A client collects clean drinking water from the dispenser, automatically triggering a transaction.
                </p>
              </div>
            </div>
            <!-- Step 2 -->
            <div class="timeline-item wow fadeInLeft" data-wow-delay="0.4s">
              <div class="timeline-icon bg-success text-white">
                <i class="fas fa-database"></i>
              </div>
              <div class="timeline-content">
                <h5>Transaction Recorded</h5>
                <p>The dispenser data is stored on the blockchain with details like date, site, and quantity.</p>
              </div>
            </div>
            <!-- Step 3 -->
            <div class="timeline-item wow fadeInLeft" data-wow-delay="0.6s">
              <div class="timeline-icon bg-warning text-white">
                <i class="fas fa-coins"></i>
              </div>
              <div class="timeline-content">
                <h5>Payment Updated</h5>
                <p>Sponsor balances are deducted, while client accounts reflect charges — ensuring fair tracking.</p>
              </div>
            </div>
            <!-- Step 4 -->
            <div class="timeline-item wow fadeInLeft" data-wow-delay="0.8s">
              <div class="timeline-icon bg-info text-white">
                <i class="fas fa-link"></i>
              </div>
              <div class="timeline-content">
                <h5>Immutable Proof</h5>
                <p>Every block links securely to the chain, creating tamper-proof evidence of each bottle’s journey.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 text-center wow fadeInRight" data-wow-delay="0.4s">
          <img src="img/water_bottle.png" alt="Blockchain Water Bottle" class="img-fluid water-bottle-animate"
  ...
  <!-- Water Bottles (Blockchain Flow) End -->
