<?php
session_start();
$current_page = basename($_SERVER['PHP_SELF']); // e.g., "contact.php"
...
if ($isLoggedIn) {
    ...
    if (isset($_SESSION['Role']) && $_SESSION['Role'] === 'Admin') {
        ...
        $stmtAudit = $conn->prepare("
            ...
            VALUES (?, 'Visit', ?, ?, ?, NOW())
        ");
        $details = "Visited contact page ($current_page)";
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if (!empty($subject) && !empty($message)) {
            $stmt = $conn->prepare("
                INSERT INTO inquiries (UserID, Subject, Message, CreatedAt)
                VALUES (?, ?, ?, NOW())
            ");
            ...
            $_SESSION['successMsg'] = "✅ Your inquiry has been sent successfully! We will reply to your registered email.";
        } else {
            $_SESSION['errorMsg'] = "⚠️ Please fill in all required fields (Subject and Message).";
        }
...
// ✅ Show feedback messages from session (if any)
...
<head>
    <meta charset="utf-8">
    <title>Hydrolink - Contact Page</title>
            ...
            <div class="row g-5">
                <div class="col-lg-6 h-100 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="text-center mx-auto pb-5" style="max-width: 800px;">
                        ...
                        <p class="mb-0">Have a question or concern? Send us a message and our team will get back to you
                            via email.</p>
                    </div>
                    ...
                    <?php if ($isLoggedIn): ?>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control border-0" placeholder="Leave a message here"
                                            id="message" name="message" style="height: 175px" required></textarea>
                        ...
                        <p class="text-muted mt-3">
                            ...
                            We’ll reply to your inquiry through your registered email address.
                        </p>
                    <?php else: ?>
                        <!-- ✅ Message for guests -->
                        <div class="alert alert-warning text-center">
                            ⚠️ Please <a href="login.php" class="alert-link">login</a> or
                            <a href="register.php" class="alert-link">register</a> to send an inquiry.
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-inline-flex rounded bg-white w-100 p-4">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-0">San Beda College Alabang, Muntinlupa, Philippines</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-xl-6">
                            <div class="d-inline-flex rounded bg-white w-100 p-4">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-0">SBCA.hydrolink@gmail.com</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-xl-6">
                        ...
                        <div class="col-12">
                            <div class="h-100 overflow-hidden">
                                ...
                                <iframe class="w-100 rounded" style="height: 400px;"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3863.900428999727!2d121.02095506412616!3d14.43290142585172!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397d1d128cce097%3A0x40607a4ca335f691!2sSan%20Beda%20College%20Alabang!5e0!3m2!1sen!2sph!4v1756870224222!5m2!1sen!2sph"
