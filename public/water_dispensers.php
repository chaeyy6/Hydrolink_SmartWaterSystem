<?php
session_start();
$current_page = basename($_SERVER['PHP_SELF']); // e.g., "water_bottles.php"
...
if (isset($_SESSION['UserID'])) {
  ...
  if (isset($_SESSION['Role']) && $_SESSION['Role'] === 'Admin') {
    ...
    $stmtAudit = $conn->prepare("
        ...
        VALUES (?, 'Visit', 'Visited Water Dispensers Page (water_dispensers.php)', ?, ?, NOW())
    ");
...
<head>
  <meta charset="utf-8">
  <title>Hydrolink - Water Dispensers</title>
...
<body>
  ...
  <div class="container-fluid position-relative p-0">
    ...
    <div class="container-fluid bg-breadcrumb">
      <div class="container text-center py-5" style="max-width: 900px;">
        <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Water Dispensers</h4>
      </div>
    </div>
    <!-- Header End -->
  </div>
  ...
  <!-- Water Dispensers (Hardware Requirements) Start -->
  <div class="container-fluid py-5 bg-light">
    <div class="container py-5">
      <!-- Section Header -->
      <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 900px;">
        <h4 class="text-uppercase text-primary">Water Dispensers</h4>
        <h1 class="display-5 mb-3">How Our Dispensers Work</h1>
        <p class="text-muted">
          Hydrolink dispensers combine <strong>IoT sensors</strong>, <strong>QR code authentication</strong>,
          and <strong>real-time blockchain logging</strong> to deliver clean water with full accountability.
          Below are the essential hardware components powering this innovation:
        </p>
      </div>
      ...
      <div class="row g-4 align-items-center">
          ...
          <div class="row g-4">
            ...
            <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
              <div class="card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body text-center p-4">
                  ...
                  <h5 class="card-title">Load Cell + HX711</h5>
                  <p class="card-text">Measures the weight of water tanks to calculate volume accurately.</p>
                </div>
              </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <div class="card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body text-center p-4">
                  ...
                  <h5 class="card-title">ESP32 Microcontroller</h5>
                  <p class="card-text">Collects sensor data and transmits it via Wi-Fi to the backend.</p>
                </div>
              </div>
            </div>
            <!-- Card 3 -->
            <div class="col-md-6 wow fadeInUp" data-wow-delay="0.4s">
              <div class="card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body text-center p-4">
                  ...
                  <p class="card-text">Authenticates users to trigger water transactions securely.</p>
                </div>
              </div>
            </div>
            <!-- Card 4 -->
            <div class="col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <div class="card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body text-center p-4">
                  ...
                  <p class="card-text">Provides wireless connectivity between ESP32 and the backend server.</p>
                </div>
              </div>
            </div>
            <!-- Card 5 -->
            <div class="col-md-6 wow fadeInUp" data-wow-delay="0.6s">
              <div class="card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body text-center p-4">
                  <div class="icon mb-3">
                    <i class="fas fa-battery-half fa-2x text-danger"></i>
                  </div>
                  <h5 class="card-title">Power Module</h5>
                  <p class="card-text">Ensures uninterrupted operation even in off-grid locations.</p>
                </div>
              </div>
            </div>
            <!-- Card 6 -->
            <div class="col-md-6 wow fadeInUp" data-wow-delay="0.7s">
              <div class="card h-100 border-0 shadow-sm rounded-4">
                <div class="card-body text-center p-4">
                  ...
                  <p class="card-text">Hosts the backend app & database, enabling real-time blockchain updates.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- Right: Illustration -->
        <div class="col-lg-5 text-center wow fadeInRight" data-wow-delay="0.8s">
          <img src="img/water_dispenser.png" alt="Hydrolink Dispenser Hardware" class="img-fluid dispenser-animate"
    ...
    <style>
      .dispenser-animate {
        animation: floatDisp 4s ease-in-out infinite;
      }
  ...
  <!-- Water Dispensers (Hardware Requirements) End -->
