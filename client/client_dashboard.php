...
<head>
  <meta charset="utf-8">
  <title>Hydrolink - Client Dashboard</title>
  ...
  <div class="container-fluid position-relative p-0">
    ...
    <div class="container-fluid bg-breadcrumb">
      <div class="container text-center py-5" style="max-width: 900px;">
        <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Client Dashboard</h4>
      </div>
    </div>
    <!-- Header End -->
  </div>
  ...
  <div class="container-fluid bg-light py-5">
    <div class="container py-5">
      ...
      <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
        <h4 class="text-uppercase text-primary">Client Dashboard</h4>
        <h1 class="display-4 text-capitalize mb-3">Welcome, <?= htmlspecialchars($_SESSION['Name'] ?? '') ?>!</h1>
        <p>Overview of your distribution site status and daily water dispensing.</p>
      </div>
      ...
      <div class="row justify-content-center mb-5">
        <div class="col-md-8">
          <div class="border rounded p-4 bg-white">
            <h5 class="mb-3">Site Profile</h5>
            <p class="mb-1"><strong>Site Name:</strong> Barangay 17 Water Kiosk</p>
            <p class="mb-1"><strong>Location:</strong> Purok 3, City Proper</p>
            <p class="mb-1"><strong>Device ID:</strong> ESP32_01</p>
            <p class="mb-1"><strong>Operating Hours:</strong> 8AM – 5PM</p>
      ...
      <div class="row justify-content-center mb-5">
        <div class="col-md-3 mb-3">
          <div class="border rounded p-4 bg-white h-100 text-center">
            <h6>Available Sponsor Funds</h6>
            <h2 class="text-primary mb-0">₱21,800</h2> <!-- Placeholder -->
          </div>
        </div>
        <div class="col-md-3 mb-3">
          <div class="border rounded p-4 bg-white h-100 text-center">
            <h6>Dispensed Today</h6>
            <h2 class="text-success mb-0">410 L</h2> <!-- Placeholder -->
          </div>
        </div>
        <div class="col-md-3 mb-3">
          <div class="border rounded p-4 bg-white h-100 text-center">
            <h6>Current Tank Level</h6>
            <h2 class="text-info mb-0">63%</h2> <!-- Placeholder -->
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="border rounded p-4 bg-white">
            <h5 class="mb-4">Recent Water Dispense Transactions</h5>
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <!-- Placeholder rows -->
                  <tr>
                    <td>May 03, 2024 11:13 AM</td>
                    <td>120 L</td>
                    <td>BlueDrop Foundation</td>
                    <td><a href="#" class="text-primary small">0000e4af1...7b</a></td>
                  </tr>
                  <tr>
                    <td>May 02, 2024 04:40 PM</td>
                    <td>90 L</td>
                    <td>Water4All PH</td>
                    <td><a href="#" class="text-primary small">0000ac76c...91</a></td>
                  </tr>
                  <!-- End placeholder -->
                </tbody>
              </table>
